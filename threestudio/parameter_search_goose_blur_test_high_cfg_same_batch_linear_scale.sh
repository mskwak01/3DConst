...
#     --gpu "0" \
#     seed="${seed}" \
#     system.tag="0805-4-blur_cause_ablation_cfg_linear_scale@baseline" \
...
python launch.py \
    ...
    --gpu "0" \
    seed="${seed}" \
    system.tag="gputest@baseline-samebatch" \
    system.three_noise=false \
    system.pytorch_three=false \
    data.num_multiview=1 \
    data.batch_size=3 \
...
python launch.py \
    ...
    --gpu "3" \
    seed="${seed}" \
    system.tag="gputest@+threenoise+multiview=2+ball" \
...
python launch.py \
    ...
    --gpu "5" \
    seed="${seed}" \
    system.tag="gputest@+disp_loss=1.0" \
    system.three_noise=false \
    system.pytorch_three=false \
    data.num_multiview=1 \
    system.prompt_processor.prompt="${prompts}" \
...
python launch.py \
    ...
    --gpu "6" \
    seed="${seed}" \
    system.tag="gputest@+disp_loss=1.0+threenoise+multiview=2+ball" \
    system.three_noise=true \
    system.pytorch_three=false \
    data.num_multiview=2 \
    system.prompt_processor.prompt="${prompts}" \
