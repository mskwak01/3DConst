...
for cfg_up_iter in 1500 2000 0
do
  python launch.py \
      ...
      --gpu "3" \
      seed="${seed}" \
      system.tag="0805-6-cfg7.5_improved_log@baseline-samebatch+cfg_change_iter=${cfg_up_iter}" \
      ...
      system.guidance.lambda_sim=0.0 \
      system.guidance.lambda_disp=0.0 \
  ...
  python launch.py \
      ...
      --gpu "4" \
      seed="${seed}" \
      system.tag="0805-6-cfg7.5_improved_log@+threenoise+multiview=2+ball+cfg_change_iter=${cfg_up_iter}" \
  ...
  python launch.py \
      ...
      --gpu "5" \
      seed="${seed}" \
      system.tag="0805-6-cfg7.5_improved_log@+sim_loss=5.0+cfg_change_iter=${cfg_up_iter}" \
      system.three_noise=false \
      system.pytorch_three=false \
      data.num_multiview=2 \
      system.prompt_processor.prompt="${prompts}" \
      ...
      system.guidance.lambda_sim=5.0 \
      system.guidance.lambda_disp=0.0 \
      trainer.max_steps="${max_steps}" \
      system.guidance.backprop_grad=false \
      system.guidance.debugging=false \
  ...
  python launch.py \
      ...
      --gpu "0" \
      seed="${seed}" \
      system.tag="0805-6-cfg7.5_improved_log@+disp_loss=1.0+cfg_change_iter=${cfg_up_iter}" \
      system.three_noise=false \
      system.pytorch_three=false \
      data.num_multiview=2 \
      system.prompt_processor.prompt="${prompts}" \
  ...
  python launch.py \
      ...
      --gpu "6" \
      seed="${seed}" \
      system.tag="0805-6-cfg7.5_improved_log@+sim_loss=5.0+threenoise+multiview=2+ball+cfg_change_iter=${cfg_up_iter}" \
      system.three_noise=true \
      system.pytorch_three=false \
      data.num_multiview=2 \
      system.prompt_processor.prompt="${prompts}" \
