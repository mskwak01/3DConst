...
#     --train \
#     --gpu 5 \
#     system.tag="ours_[0,0,0.5,3000]@cfg100" \
...
#     system.guidance.disp_loss_to_latent=false \
#     trainer.val_check_interval=50 \
#     system.guidance.grad_clip=[0,0.0,0.5,3000]
# done
...
#     system.guidance.disp_loss_to_latent=false \
#     trainer.val_check_interval=50 \
#     system.guidance.grad_clip=[0,0.0,2.0,3000] &
# done
...
#     system.guidance.disp_loss_to_latent=false \
#     trainer.val_check_interval=50 \
#     system.guidance.grad_clip=[0,0.0,4.0,3000]
# done
