...
# python launch.py --config custom/threestudio-3dgs/configs/gs_sds_pc_init_noising_full.yaml  --train --gpu 4 system.tag="tester_view_2_2_pts_002_interp_masking_allview" system.gradient_masking=true system.interpolated_masking=true system.prompt_processor.prompt="a rabbit on a pancake"  system.image_dir="/home/cvlab15/project/woojeong/naver/images/rabbit-pancake.jpeg" data.batch_size=2 data.num_multiview=2 data.multiview_deg=20.0 system.calibration_value=90 data.front_optimize=false system.pts_radius=0.02
