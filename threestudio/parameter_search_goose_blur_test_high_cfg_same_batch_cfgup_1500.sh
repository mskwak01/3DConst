...
python launch.py \
    ...
    --gpu "3" \
    seed="${seed}" \
    system.tag="0805-5-blur_cause_ablation_cfgup_sim_loss@baseline-samebatch" \
...
python launch.py \
    ...
    --gpu "4" \
    seed="${seed}" \
    system.tag="0805-5-blur_cause_ablation_cfgup_sim_loss@+threenoise+multiview=2+ball" \
...
python launch.py \
    ...
    --gpu "5" \
    seed="${seed}" \
    system.tag="0805-5-blur_cause_ablation_cfgup_sim_loss@+sim_loss=5.0" \
    system.three_noise=false \
    system.pytorch_three=false \
    data.num_multiview=2 \
    system.prompt_processor.prompt="${prompts}" \
...
python launch.py \
    ...
    --gpu "0" \
    seed="${seed}" \
    system.tag="0805-5-blur_cause_ablation_cfgup_sim_loss@+disp_loss=1.0" \
    system.three_noise=false \
    system.pytorch_three=false \
    data.num_multiview=2 \
    system.prompt_processor.prompt="${prompts}" \
...
python launch.py \
    ...
    --gpu "6" \
    seed="${seed}" \
    system.tag="0805-5-blur_cause_ablation_cfgup_sim_loss@+sim_loss=5.0+threenoise+multiview=2+ball" \
    system.three_noise=true \
    system.pytorch_three=false \
    data.num_multiview=2 \
    system.prompt_processor.prompt="${prompts}" \
